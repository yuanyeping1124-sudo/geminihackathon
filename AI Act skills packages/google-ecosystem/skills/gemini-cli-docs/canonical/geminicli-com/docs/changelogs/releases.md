---
source_url: http://geminicli.com/docs/changelogs/releases
source_type: llms-txt
content_hash: sha256:c144b2d6ef547281509c98d6fbab36968b816909dfb691b94eb31b8a0ec1af9b
sitemap_url: https://geminicli.com/llms.txt
fetch_method: markdown
etag: '"1c351335fb6b9cdd53144b0427b6d5521fdeec0e787a69541414e851e8ffe91a"'
...
- **Experimental permission improvements**: We're experimenting with a new
  ...
  See our [policy engine documentation](/docs/core/policy-engine) to learn how
  to use this feature.
- **Gemini 3 support rolled out for some users**: Some users can now enable
  ...
  our [Gemini 3 on Gemini CLI documentation](/docs/get-started/gemini-3) to find
