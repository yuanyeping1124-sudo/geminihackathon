...
content_hash: sha256:5cd59b82f3c04e92cb50080ce2c80c0899ccfbe64a25ce2be17a526457394a1a
sitemap_url: https://geminicli.com/llms.txt
fetch_method: markdown
etag: '"8dfa64cd7ff3dc328f05aef8322a4536a25b3b605ee5bcb7daa926a66651775b"'
last_modified: '2026-01-06T14:06:10Z'
---
...
See [writing hooks guide](/docs/hooks/writing-hooks) for a tutorial on creating your
first hook and a comprehensive example.

See [hooks reference](/docs/hooks/reference) for the technical specification of the I/O
schemas.

See [best practices](/docs/hooks/best-practices) for guidelines on security, performance,
and debugging.
...
See [Security Considerations](/docs/hooks/best-practices#using-hooks-securely) for a
...
- [Custom Commands](/docs/cli/custom-commands) - Create reusable prompt
  shortcuts
- [Configuration](/docs/cli/configuration) - Gemini CLI configuration options
